      ...
      <SheetContent className="sm:max-w-md border-l border-border/50 bg-background/95 backdrop-blur-xl p-0">
        <SheetHeader className="px-6 py-6 border-b border-border/50">
          ...
          <SheetDescription className="text-base">
            Refine your order list by status, date, or order ID.
          </SheetDescription>
        </SheetHeader>
        ...
        <div className="px-6 py-8 pb-36 space-y-8 overflow-y-auto max-h-[calc(100vh-200px)]">
          ...
          <div className="space-y-3">
            <Label htmlFor="order-search" className="text-sm font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
          ...
          {/* Date Filter */}
          <div className="space-y-3">
            <Label className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Time Period</Label>
